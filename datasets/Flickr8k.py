...
class Flickr8kDataset(Dataset):
    ...
    def __init__(self, root: str, captions_file: str, transform=None, tokenizer: CharacterTokenizer = None):
        ...
        if os.path.isdir(os.path.join(self.root, "Images")):
            ...
            raise RuntimeError(
                "Image directory not found. Expected 'Images' or 'Flicker8k_Dataset'.")
    ...
    def __getitem__(self, idx: int) -> tuple:
        ...
        try:
            ...
            print(
                f"Warning: Image file not found at {img_path}. Skipping to next sample.")
        ...
        model_input_sequence = [self.tokenizer.get_sos_token_id(
        )] + caption_tokens + [self.tokenizer.get_eos_token_id()]
